...
import 'package:ving/utils/third_app_utils.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(
            tooltip: I18n.of(context).openBrowser,
      ...
      bottomNavigationBar: BottomAppBar(
        child: IconTheme(
          ...
          child: Row(
            ...
            //       var tag = 'detail';
            //       return IconButton(
            //         tooltip: I18n.of(context).favourites,
            //         icon: Hero(
            //           tag: tag,
            //           child: Icon(
  ...
  Widget build(BuildContext context) {
    return PopupMenuButton(
      itemBuilder: (context) => <PopupMenuEntry<int>>[
        PopupMenuItem(
          child: WebViewPopupMenuItem(Icons.share, I18n.of(context).share),
          value: 2,
        ),
//        PopupMenuDivider(),
      ],
