...
import 'package:ving/ui/widget/button_progress_indicator.dart';
import 'package:ving/ui/widget/third_component.dart';
import 'package:ving/view_model/login_model.dart';

import 'package:ving/ui/page/user/login_widget.dart';
...
class _SingUpWidgetState extends State<SingUpWidget> {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Text.rich(TextSpan(text: I18n.of(context).noAccount, children: [
        TextSpan(
            text: I18n.of(context).toSignUp,
