      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Text(
              message ?? I18n.of(context).pageStateError,
...
class ViewStateEmptyWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewStateWidget(
      ...
      message: message ?? I18n.of(context).viewStateMessageEmpty,
      buttonText: buttonText ??
          Text(
            I18n.of(context).viewStateButtonRefresh,
...
class ViewStateUnAuthWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewStateWidget(
      ...
      message: message ?? I18n.of(context).viewStateMessageUnAuth,
      buttonText: buttonText ??
          Text(
...
class ViewStateButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OutlineButton(
      child: child ??
          Text(
            I18n.of(context).pageStateRetry,
            style: TextStyle(wordSpacing: 5),
          ),
